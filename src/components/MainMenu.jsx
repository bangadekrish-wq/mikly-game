    ...
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px', marginBottom: '30px', width: '100%', padding: '0 10px', boxSizing: 'border-box' }}>
        ...
        <div style={{ 
          ...
          <div onClick={() => setSelectedBird('/bird5.png')} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', cursor: 'pointer', transition: 'transform 0.2s', transform: selectedBird === '/bird5.png' ? 'scale(1.2)' : 'scale(1)', opacity: selectedBird === '/bird5.png' ? 1 : 0.5 }}>
            <img src="/bird5.png" alt="Krish" style={{ width: 'clamp(60px, 20vw, 80px)', height: 'clamp(60px, 20vw, 80px)', objectFit: 'contain' }} />
            <div style={{ color: 'white', fontWeight: 'bold', textShadow: '1px 1px 0 #000', marginTop: '5px' }}>Krish</div>
          </div>
        </div>
