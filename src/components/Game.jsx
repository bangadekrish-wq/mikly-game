...
const Game = ({ onMenu, highScore, setHighScore, selectedBird, soundEnabled, setSoundEnabled }) => {
  ...
  return (
    <div className="game-container">
      ...
      <video ref={bgMusicRef} playsInline style={{ display: 'none' }} src={selectedBird === '/bird3.png' ? "/bg-abhinav.mp4" : selectedBird === '/bird2.png' ? "/bg-manjil.mp3" : "/bg-music.mp3"} loop preload="auto" />
      <video ref={gameOverMusicRef} playsInline style={{ display: 'none' }} src={selectedBird === '/bird3.png' ? "/gameover-abhinav.mp4" : selectedBird === '/bird.png' ? "/gameover-kshitij.mp3" : "/gameover.mp3"} preload="auto" />
    </div>
  );
};
